...
knowledge0 = And(
    ...
    Implication(AKnave, Or(And(Not(AKnight), Not(AKnave)), Not(AKnight), Not(AKnave)))
)
...
knowledge1 = And(
    ...
    Implication(AKnave, Or(And(AKnight, BKnight), And(AKnight, BKnave), And(AKnave, BKnight)))
)
